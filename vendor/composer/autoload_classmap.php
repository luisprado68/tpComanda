...
return array(
    'Apps\\Controllers\\BebidaController' => $baseDir . '/src/controllers/bebidaController.php',
    'Apps\\Controllers\\ClienteController' => $baseDir . '/src/controllers/clienteController.php',
    'Apps\\Controllers\\ComidaController' => $baseDir . '/src/controllers/comidaController.php',
    'Apps\\Controllers\\EncuestaController' => $baseDir . '/src/controllers/encuestaController.php',
    'Apps\\Controllers\\EstadosMesaController' => $baseDir . '/src/controllers/estadosMesasController.php',
    'Apps\\Controllers\\EstadosPedidoController' => $baseDir . '/src/controllers/estadosPedidoController.php',
    'Apps\\Controllers\\IngresoController' => $baseDir . '/src/controllers/ingresoController.php',
    'Apps\\Controllers\\InscripcionController' => $baseDir . '/src/controllers/inscripcionController.php',
    'Apps\\Controllers\\MateriaController' => $baseDir . '/src/controllers/materiaController.php',
    'Apps\\Controllers\\MesaController' => $baseDir . '/src/controllers/mesaController.php',
    'Apps\\Controllers\\OperacionController' => $baseDir . '/src/controllers/operacionController.php',
    'Apps\\Controllers\\PedidoController' => $baseDir . '/src/controllers/pedidoController.php',
    'Apps\\Controllers\\PostreController' => $baseDir . '/src/controllers/postreController.php',
    'Apps\\Controllers\\UsuarioController' => $baseDir . '/src/controllers/usuarioController.php',
    'Apps\\Middlewares\\AuthMiddleware' => $baseDir . '/src/middlewares/authMiddleware.php',
    'Apps\\Middlewares\\JsonMiddleware' => $baseDir . '/src/middlewares/jsonMiddleware.php',
    'Apps\\models\\Bebida' => $baseDir . '/src/models/bebida.php',
    'Apps\\models\\Cliente' => $baseDir . '/src/models/cliente.php',
    'Apps\\models\\Comida' => $baseDir . '/src/models/comida.php',
    'Apps\\models\\Encuesta' => $baseDir . '/src/models/encuesta.php',
    'Apps\\models\\EstadosMesa' => $baseDir . '/src/models/estadosmesas.php',
    'Apps\\models\\EstadosPedido' => $baseDir . '/src/models/estadospedido.php',
    'Apps\\models\\Ingreso' => $baseDir . '/src/models/ingreso.php',
    'Apps\\models\\Inscripcion' => $baseDir . '/src/models/inscripcion.php',
    'Apps\\models\\Materia' => $baseDir . '/src/models/materia.php',
    'Apps\\models\\Mesa' => $baseDir . '/src/models/mesa.php',
    'Apps\\models\\Operacion' => $baseDir . '/src/models/operacion.php',
    'Apps\\models\\Pedido' => $baseDir . '/src/models/pedido.php',
    'Apps\\models\\Postre' => $baseDir . '/src/models/postre.php',
    'Apps\\models\\Usuario' => $baseDir . '/src/models/usuario.php',
    'Apps\\models\\Validar' => $baseDir . '/src/models/validar.php',
